...
public class Main {
    ...
    private final ClientService clientService = context.getBean(ClientService.class);
    private final VehicleService vehicleService = context.getBean(VehicleService.class);
    private final ReservationService reservationService = context.getBean(ReservationService.class);
    ...
    switch (choix) {
        ...
        case 8 -> listReservations();
        case 9 -> deleteReservation();
        case 10 -> listResaByVehicleId();
        case 11 -> listResaByClientId();
    ...
    private void createClient() {
        Client client = new Client(0, IOUtils.readString("Nom : ", true), IOUtils.readString("Prénom : ", true), IOUtils.readString("Email : ", true), IOUtils.readDate("Date de naissance (jj/mm/aaaa) : ", true));
        try {
    ...
    private void createVehicle() {
        Vehicle vehicle = new Vehicle(0, IOUtils.readString("Constructeur : ", true), IOUtils.readString("Modèle : ", true), IOUtils.readInt("Nombre de places : "));
        try {
    ...
    private void createReservation() {
        Reservation reservation = new Reservation(0, IOUtils.readInt("ID du client : "), IOUtils.readInt("ID du véhicule : "), IOUtils.readDate("Date de début (jj/mm/aaaa) : ", true), IOUtils.readDate("Date de fin (jj/mm/aaaa) : ", true));
        try {
