        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <!-- form start -->
                        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/users/edit?id=${id}">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="date_naissance" name="date_naissance" placeholder="Date de naissance" value="${client.naissance()}" required>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
