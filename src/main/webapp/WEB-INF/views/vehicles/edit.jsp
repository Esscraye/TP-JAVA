            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box">
                        ...
                        <!-- /vehicles/create -->
                        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/cars/edit?id=${id}">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="manufacturer" name="constructeur" placeholder="Marque" value="${vehicle.constructeur()}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="seats" name="nbPlaces" placeholder="Nombre de places" value="${vehicle.nbPlaces()}" required>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
